...
public class ShurikenItem extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        world.playSound(null, user.getX(), user.getY(), user.getZ(), ModSounds.ENTITY_SHURIKEN_THROW,
        ...
        if (!world.isClient) {
            ...
            shurikenEntity.setVelocity(user, user.getPitch(), user.getYaw(), 0.0f, speed,
                    1.0f);
